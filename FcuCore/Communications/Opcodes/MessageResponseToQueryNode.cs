...
namespace FcuCore.Communications {
    ...
    public class MessageResponseToQueryNode:MessageNode
    {
        ...
        public bool IsConsumerNode => (Data[4] & 0b1000) == 0b1000;
        public bool IsProducerNode => (Data[4] & 0b0100) == 0b0100;
        public bool InFlimMode => (Data[4] & 0b0010) == 0b0010;
        public bool SupportsBootloader => (Data[4] & 0b0001) == 0b0001;
